...
const CardWithBackgroundImage = ({data}: CardProps) => {
  const styles = css`
...
<h4>
  <a href="#" tw='text-white text-2xl leading-9 font-semibold mb-[50px] inline-block'> {data.description}</a>
</h4>
<Button css={stylesButton(data.isCardBlog)} variant={data.isCardBlog ? 'secondary' :'grey'}>View Details</Button>
</div>
    </div>
  )
}
