...
const styleWrapper = (headerIsTransparent: boolean) => [
  ...
  headerIsTransparent && tw`bg-transparent py-4 absolute`,
];
interface Props {
  tabs: string[];
  activeTab: string;
      ...
      <header css={styleWrapper(headerIsTransparent)}>
        <div tw="flex items-center">
          ...
          <Nav isOpen={isOpen}>
            ...
            <button
              type="button"
              tw="absolute top-3 right-8 text-3xl cursor-pointer md:hidden"
        ...
        <div tw="flex items-center justify-between space-x-2">
          ...
          <button
            type="button"
            tw="cursor-pointer text-3xl hover:text-secondary flex justify-center items-center md:hidden"
